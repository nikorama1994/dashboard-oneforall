(function(){
  ...
  function forceMenuVisibility(context){
    ...
    function hideSystem(){
      ...
      ['sideDatabase','sideBackup','sideSettings'].forEach(hide);
    }

    // Reset menu yang bisa berubah antar role.
    ...
    // QC Inspector: menu tetap terlihat sesuai spesifikasi,
    // tetapi Database & Pengaturan dikunci oleh guard terpisah.
  }
