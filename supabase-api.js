(function(){
  ...
  async function getCurrentContext(){
    ...
    const {data:profile,error:profileError}=await sb.from('profiles').select('id,email,username,name,role,requested_role,approval_status,approved_at').eq('id',user.id).maybeSingle();
